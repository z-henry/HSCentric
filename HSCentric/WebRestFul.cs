...
namespace HSCentric
{
	...
	public interface IRestFulServices
	{
		...
		//curl "http://127.0.0.1:9000/hscentric/v1/Hearthstone" -X GET
		// 		[OperationContract]
		...
		//>curl "http://127.0.0.1:9000/hscentric/v1" -H "Content-Type:application/json" -d "{\"enable\":false,\"name\":\"Hearthstone\"}" -X POST
		[OperationContract]
